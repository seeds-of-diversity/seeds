...
class SLProfiles_GroundCherry
{
    ...
    static function GroundCherryForm( SLProfilesDefs $oSLProfilesDefs, SLProfilesDB $oDB, int $kVI, string $eForm )
    {
        $raFormCommon = [
            ...
            [   'cmd'=>'q_d', 'k'=>'common_SoD_d__germdate'],
        ...
        $raFormCGO = [
            ...
            [   'cmd'=>'q_i', 'k'=>'ground-cherry_SoD_i__uprightplants'],
            [   'cmd'=>'q_i', 'k'=>'ground-cherry_SoD_i__lowplantsremoved'],
            [   'cmd'=>'q_i', 'k'=>'ground-cherry_SoD_b__floweringatremoval'],

            ['cmd'=>'section', 'title_EN'=>"Tasting berries and saving seeds", 'title_FR'=>"Tasting berries and saving seeds"],
            [   'cmd'=>'q_i', 'k'=>'ground-cherry_SoD_i__fruittasted'],
            [   'cmd'=>'q_i', 'k'=>'ground-cherry_SoD_i__fruitharvestseeds'],
